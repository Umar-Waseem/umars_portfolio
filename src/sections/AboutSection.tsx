  ...
  return (
    <main className='about-section flex flex-col justify-center h-screen p-10 bg-black lg:items-start items-center text-white theContainer section'>
      <div className="lg:w-3/5">
        <h1 className='font-semibold text-2xl lg:text-7xl mb-6 lg:text-left text-center'>Muhammad Umar Waseem</h1>
        <p className='font-semibold lg:text-4xl mb-6 gradient-text lg:text-left text-center'>
